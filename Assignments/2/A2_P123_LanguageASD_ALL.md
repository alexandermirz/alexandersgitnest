...
```
## Warning in checkConv(attr(opt, "derivs"), opt$par, ctrl =
## control$checkConv, : Model failed to converge with max|grad| = 0.00350287
## (tol = 0.002, component 1)
```
...
```
## [1] 0.6018996 0.6476340 0.8838941 0.7339768 0.9081959
```
...
```
## Warning in checkConv(attr(opt, "derivs"), opt$par, ctrl =
## control$checkConv, : Model failed to converge with max|grad| = 0.0047129
## (tol = 0.002, component 1)
```
...
```
## [1] 0.5662439 0.6681413 0.5317931 0.4695417 0.6200723
```
